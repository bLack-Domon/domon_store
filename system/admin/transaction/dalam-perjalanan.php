...
$select_invoice = $server->query("SELECT * FROM `iklan`, `kategori`, `akun`, `invoice` WHERE  invoice.tipe_progress='Dikirim' AND invoice.id_iklan=iklan.id AND iklan.id_kategori=kategori.id AND invoice.id_user=akun.id ORDER BY `invoice`.`idinvoice` DESC");
...
?>
    ...
    <div class="box_isi_res_order">
        ...
        ?>
            <div class="isi_cart" id="isi_cart_kajgf<?php echo $invoice_data['id']; ?>">
